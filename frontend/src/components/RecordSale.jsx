...
const RecordSale = ({ token }) => {
  ...
  const { product, customer, invoice, quantity } = formData;
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <input type="text" placeholder="Customer" name="customer" value={customer} onChange={onChange} />
